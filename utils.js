...
const spreadsheetId = '1f7a_uALg7lUzvkCzlnJ5IUBlh41ecSo9TGOkPVbCa6Q'
...
async function appendToSheet(values) {
    ...
    const range = 'facbot!A1';  // The range in the sheet where data will be written.
...
async function readSheet(range) {
    ...
    //const range = 'facbot!A1:E10';  // Specifies the range to read.
...
(async () => {
    ...
    //const data = await readSheet("facbot!A1:J10");  // Reads data from the sheet.
